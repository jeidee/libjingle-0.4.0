...
class FileShareClient : public sigslot::has_slots<>, public talk_base::MessageHandler {
 ...
 private:
  ...
  void OnSignon() {
    ...
    port_allocator_.reset(new cricket::SimplePortAllocator(&network_manager_, "pcp"));
  ...
  talk_base::scoped_ptr<cricket::SimplePortAllocator> port_allocator_;
...
int main(int argc, char **argv) {
  ...
  xcs.set_server(talk_base::SocketAddress("10.211.55.2", 5223));
